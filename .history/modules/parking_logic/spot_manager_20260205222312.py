...
class SpotManager:
    ...
    def detect_spots_initial(self, frame):
        ...
        # 5. SAVE DEBUG IMAGE (This is what you asked for!)
        # We draw the detected spots on the image we scanned and save it.
        ...
        print(
            f"💾 DEBUG: Saved visualization to '{debug_path}'. PLEASE CHECK THIS IMAGE."
        )
